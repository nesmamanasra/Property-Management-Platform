    ...
    <div className="min-h-screen bg-[#f5f5f7]">
      <div className="mx-auto flex min-h-screen max-w-[1440px] flex-col lg:flex-row">
        ...
        <div className="flex w-full items-center justify-center px-6 py-10 lg:w-1/2 lg:px-16">
          <div className="w-full max-w-[430px]">
            ...
            <div className="mb-16 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-indigo-100">
                <div className="grid grid-cols-2 gap-1">
                  ...
                  <span className="h-2.5 w-2.5 rounded-full bg-indigo-500"></span>
                  <span className="h-2.5 w-2.5 rounded-full bg-indigo-700"></span>
                </div>
              </div>
              <h1 className="text-[24px] font-semibold tracking-tight text-[#222]">
                Sellora
              </h1>
            </div>
            ...
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-[42px] font-semibold leading-tight text-[#1f1f1f]">
                Welcome Back
              </h2>
            ...
            <form className="space-y-5">
              ...
              <button
                type="submit"
                className="h-12 w-full rounded-lg bg-gradient-to-r from-indigo-600 to-indigo-500 text-sm font-semibold text-white shadow-md transition hover:scale-[1.01] hover:shadow-lg"
              >
                Log In
              </button>
            </form>
        ...
        <div className="hidden w-full p-4 lg:block lg:w-1/2">
          <div className="relative flex h-full min-h-[720px] items-center overflow-hidden rounded-[28px] bg-gradient-to-br from-[#4a42ff] via-[#4038f5] to-[#3b33ef] px-12 py-14 text-white">
            {/* Background Shapes */}
