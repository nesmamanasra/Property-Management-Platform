        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center">
         <div className="flex items-center">
          ...
          <div className="flex items-center justify-end gap-3">
            <button className="px-5 py-2 rounded-lg border border-[#E6ECF3] bg-white font-bold text-[#102A43] shadow-[0_6px_14px_rgba(15,23,42,0.10)] hover:shadow-[0_8px_18px_rgba(15,23,42,0.12)] transition">
              Log In
            </button>

            <button className="px-5 py-2 rounded-lg text-white font-bold bg-gradient-to-b from-[#1F3C88] to-[#18346F] shadow-[0_10px_22px_rgba(31,60,136,0.30)] hover:opacity-95 transition">
              Get Started
            </button>
          </div>
        </div>
